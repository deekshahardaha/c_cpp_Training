...
public:
    ...
    // Overloading the < operator for sorting by age
...
int main64() {
    ...
    auto lower = lower_bound(people.begin(), people.end(), Person("Dummy", 30), [](const Person& a, const Person& b) {
        return a.age < b.age;
    });
    if (lower != people.end()) {
    ...
    auto upper = upper_bound(people.begin(), people.end(), Person("Dummy", 30), [](const Person& a, const Person& b) {
        return a.age < b.age;
    });
    if (upper != people.end()) {
